...
<h2><?php  echo __('Researcher'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($researcher['Researcher']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Researcher'), array('action' => 'edit', $researcher['Researcher']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Researcher'), array('action' => 'delete', $researcher['Researcher']['id']), null, __('Are you sure you want to delete # %s?', $researcher['Researcher']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Researchers'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Researcher'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($researcher['Research'])): ?>
	...
	<?php
		$i = 0;
		foreach ($researcher['Research'] as $research): ?>
		<tr>
