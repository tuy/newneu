...
<?php echo $this->Form->create('Consult'); ?>
	<fieldset>
		<legend><?php echo __('Edit Consult'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Consult.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Consult.id'))); ?></li>
