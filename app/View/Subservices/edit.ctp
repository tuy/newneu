...
<?php echo $this->Form->create('Subservice'); ?>
	<fieldset>
		<legend><?php echo __('Edit Subservice'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Subservice.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Subservice.id'))); ?></li>
