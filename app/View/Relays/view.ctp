...
<h2><?php  echo __('Relay'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($relay['Relay']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Path'); ?></dt>
		<dd>
			<?php echo h($relay['Relay']['path']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Relay'), array('action' => 'edit', $relay['Relay']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Relay'), array('action' => 'delete', $relay['Relay']['id']), null, __('Are you sure you want to delete # %s?', $relay['Relay']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Relays'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Relay'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($relay['Element'] as $element): ?>
		<tr>
