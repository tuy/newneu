...
<h2><?php  echo __('Evaluate'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($evaluate['Evaluate']['path']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Evaluate'), array('action' => 'delete', $evaluate['Evaluate']['id']), null, __('Are you sure you want to delete # %s?', $evaluate['Evaluate']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($evaluate['Element'] as $element): ?>
		<tr>
