...
<?php echo $this->Form->create('Submanagement'); ?>
	<fieldset>
		<legend><?php echo __('Edit Submanagement'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Submanagement.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Submanagement.id'))); ?></li>
