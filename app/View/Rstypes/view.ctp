<div class="rstypes view">
<h2><?php  echo __('Rstype'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($rstype['Rstype']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($rstype['Rstype']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Rstype'), array('action' => 'edit', $rstype['Rstype']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Rstype'), array('action' => 'delete', $rstype['Rstype']['id']), null, __('Are you sure you want to delete # %s?', $rstype['Rstype']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Rstypes'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Rstype'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($rstype['Research'] as $research): ?>
		<tr>
